...
for(category_name in names(covariates_to_test)) {
  ...
  for(covariate_name in covariates_to_test[[category_name]]) {
    ...
    cat(sprintf("  %s %-30s n=%3d b=%5.3f p=%5.3f%s\n",
                agreement_icon,
...
cat(sprintf("  Correlation approx Regression: %d/%d (%.1f%% agreement)\n",
...
for(i in 1:nrow(phase2_results)) {
  ...
  if(!is.na(perm_cor_p)) {
    cat(sprintf("  %s %-25s b=%5.3f p_c=%5.3f p_pc=%5.3f p_pr=%5.3f%s\n",
                agreement_icon,
    ...
    cat(sprintf("  %s %-25s b=%5.3f p_c=%5.3f p_pr=%5.3f%s\n",
                agreement_icon,
                substr(covariate_name, 1, 25),
                phase2_results$reg_coefficient[i],
                phase2_results$reg_pval[i],
...
cat(sprintf("   - Correlation approx Regression: %.1f%% agreement\n",
