...
*                                                        
clear all                                        
insheet using fa2000hd_data_stata.csv, comma clear
...
label define chfnm -1 "{Not reported}" 
/*label define chfnm Alpha "{Alpha}", add 
label values chfnm chfnm*/
/*label define chftitle -1 "{Not reported}" 
label define chftitle Alpha "{Alpha}", add 
label values chftitle chftitle*/
/*label define gentele -1 "{Not reported}" 
label define gentele Alpha "{Alpha}", add
label values gentele gentele*/
/*label define fintele -1 "{Not reported}" 
label define fintele Alpha "{Alpha}", add 
label values fintele fintele*/
/*label define admtele -1 "{Not reported}" 
label define admtele Alpha "{Alpha}", add 
label values admtele admtele*/
...
label define opeflag 4 "New participants (became eligible during the fall collection period)", add 
...
label define control 1 "Public" 
label define control 2 "Private, nonprofit", add 
label define control 3 "Private, for-profit", add 
label values control control
label define affil 1 "Public" 
label define affil 2 "Private, for-profit", add 
label define affil 3 "Private, nonprofit, no religious affiliation", add 
label define affil 4 "Private, nonprofit", add 
label values affil affil
label define hloffer -2 "{Not applicable, first-professional only}" 
label define hloffer -3 "{Not available}", add 
label define hloffer 0 "Other", add 
...
label define fpoffer -3 "{Not available}" 
label define fpoffer 1 "First-professional degree/certificate", add 
label define fpoffer 2 "No first-professional offering", add 
label values fpoffer fpoffer
label define hdegoffr 0 "Non-degree granting" 
label define hdegoffr 1 "First-professional only", add 
label define hdegoffr 10 "Doctoral", add 
label define hdegoffr 11 "Doctoral and first-professional", add 
label define hdegoffr 20 "Masters", add 
label define hdegoffr 21 "Masters and first-professional", add 
label define hdegoffr 30 "Bachelors", add 
label define hdegoffr 31 "Bachelors and first-professional", add 
label define hdegoffr 40 "Associates", add 
label values hdegoffr hdegoffr
label define deggrant 1 "Degree-granting" 
label define deggrant 2 "Nondegree-granting, primarily postsecondary", add 
label define deggrant 3 "Nondegree-granting, not  primarily postsecondary", add 
label define deggrant 4 "Not an educational entity", add 
label values deggrant deggrant
label define hbcu 1 "Yes" 
label define hbcu 2 "No", add 
label values hbcu hbcu
label define hospital 1 "Yes" 
label define hospital 2 "No", add 
label values hospital hospital
label define medical 1 "Yes" 
...
label define locale 1 "Large city", add 
label define locale 2 "Mid-size city", add 
label define locale 3 "Urban fringe of large city", add 
label define locale 4 "Urban fringe of mid-size city", add 
label define locale 5 "Large town", add 
label define locale 6 "Small town", add 
label define locale 7 "Rural", add 
label define locale 9 "Not assigned", add 
label values locale locale
label define openpubl 1 "Insititution is open to the public" 
label define openpubl 2 "Insititution is not open to the public", add 
...
label define act S "Split - split into more than one institution", add 
label define act Z "Universe III - out-of-scope", add 
label values act act*/
/*label define closedat -2 "{Item not applicable}" 
label define closedat Alpha "{Alpha}", add 
label values closedat closedat*/
label define stat_fa -2 "{Item not applicable}" 
label define stat_fa 1 "Response", add 
label define stat_fa 3 "Nonresponse, not imputed", add 
label values stat_fa stat_fa
label define pseflag 1 "Active postsecondary institution" 
label define pseflag 2 "not primarily postsec or open to public", add 
...
label define lock_fa 0 "Inactive, not registered" 
label define lock_fa 10 "User level, inactive, registered", add 
label define lock_fa 11 "User level active, partial", add 
label define lock_fa 141 "Closed, or out-of-scope", add 
label define lock_fa 151 "Refused", add 
label define lock_fa 20 "Coordinator level inactive", add 
label define lock_fa 21 "Coordinator level active  partial", add 
label define lock_fa 71 "Complete", add 
label define lock_fa 81 "Migrated", add 
label values lock_fa lock_fa
/*label define date_fa -2 "{Item not applicable}" 
label define date_fa Alpha "{Alpha}", add 
label values date_fa date_fa*/
label define stat_ic -2 "{Item not applicable}" 
label define stat_ic 1 "Respondent", add 
label define stat_ic 3 "Nonrespondent, not imputed", add 
label values stat_ic stat_ic
label define stat_c -2 "Not in imputation scope" 
label define stat_c 1 "Respondent", add 
label define stat_c 2 "Partial response", add 
label define stat_c 3 "Nonrespondent, not imputed", add 
label define stat_c 4 "Total nonrespondent, data imputed", add 
label values stat_c stat_c
label define prch_c -2 "{Item not applicable}" 
label define prch_c -9 "{Form not mailed}", add 
label define prch_c 1 "Parent data record", add 
label define prch_c 2 "Child data record, no data", add 
label values prch_c prch_c
label define imp_c -2 "{Item not applicable}" 
label define imp_c 1 "Carry forward (CF)", add 
label define imp_c 2 "Nearest neighbor (NN)", add 
label define imp_c 3 "Group median (GM)", add 
label define imp_c 4 "Both CF and NN", add 
label define imp_c 6 "Both NM and GM", add 
label values imp_c imp_c
label define stat_sp 1 "Respondent" 
label define stat_sp 3 "Nonrespondent", add 
label values stat_sp stat_sp
label define form_f 1 "Finance form for public institutions" 
label define form_f 2 "Finance form for private not-for-profit  institutions", add 
label define form_f 3 "Finance form for private for-profit  institutions", add 
label values form_f form_f
label define gpfs -1 "Dont know" 
label define gpfs 1 "Yes", add 
label define gpfs 2 "No", add 
label values gpfs gpfs
label define f1gasbcr 1 "AICPA College and University Audit Guide Model" 
label define f1gasbcr 2 "GASB Governmental Model", add 
label values f1gasbcr f1gasbcr
label define f1gasbal -1 "Dont know or undecided at this time" 
label define f1gasbal 1 "Business Type Activities", add 
label define f1gasbal 2 "Governmental Activities", add 
label define f1gasbal 3 "Governmental Activities with Business-Type Activities", add 
label values f1gasbal f1gasbal
label define stat_gr -2 "not applicable" 
label define stat_gr 1 "Respondent", add 
label define stat_gr 3 "Nonrespondent", add 
label values stat_gr stat_gr
label define prch_gr -2 "not applicable" 
label define prch_gr 1 "Parent institution - included data from branch campuses (child)", add 
label define prch_gr 2 "Child instittution - all data reported with parent", add 
label values prch_gr prch_gr
label define cohrtstu 1 "Yes, has full-time, first-time undergraduates and data is available" 
label define cohrtstu 2 "Yes, has full-time, first-time undergraduates, but data is not available", add 
label define cohrtstu 3 "No, did not enroll full-time first-time undergraduate students", add 
label define cohrtstu 4 "No, did not offer programs below the baccalaureate level", add 
label values cohrtstu cohrtstu
label define cohrtyr1 -2 "not applicable" 
label define cohrtyr1 1995 "1995", add 
label define cohrtyr1 1996 "1996", add 
label define cohrtyr1 1997 "1997", add 
label define cohrtyr1 1999 "1999", add 
label define cohrtyr1 2003 "2003", add 
label values cohrtyr1 cohrtyr1
label define pyaid -2 "not applicable" 
label define pyaid 1 "Yes", add 
label define pyaid 2 "No", add 
label values pyaid pyaid
label define cohrtaid -2 "not applicable" 
label define cohrtaid 1 "Yes", add 
label define cohrtaid 2 "No", add 
label values cohrtaid cohrtaid
label define sport1 -2 "not applicable" 
label define sport1 0 "No", add 
label define sport1 1 "Yes", add 
label define sport1 2 "implied no", add 
label values sport1 sport1
label define sport2 -2 "not applicable" 
label define sport2 0 "No", add 
label define sport2 1 "Yes", add 
label define sport2 2 "implied no", add 
label values sport2 sport2
label define sport3 -2 "not applicable" 
label define sport3 0 "No", add 
label define sport3 1 "Yes", add 
label define sport3 2 "implied no", add 
label values sport3 sport3
label define sport4 -2 "not applicable" 
label define sport4 0 "No", add 
label define sport4 1 "Yes", add 
label define sport4 2 "implied no", add 
label values sport4 sport4
label define sport5 -2 "not applicable" 
label define sport5 0 "No", add 
label define sport5 1 "Yes", add 
label define sport5 2 "implied no", add 
label values sport5 sport5
label define transver -2 "Not applicable" 
label define transver 1 "Yes,  has information on students who transfer out.", add 
label define transver 2 "Yes, but  does not have any information on students who transfer out", add 
label define transver 3 "No", add 
label values transver transver
label define longpgm -2 "not applicable" 
label define longpgm 1 "Yes", add 
label define longpgm 2 "No", add 
label values longpgm longpgm
label define ocrhsi -1 "Enrollment data not reported" 
label define ocrhsi -2 "Not applicable, institution is not in-scope of HSI calculation.", add 
label define ocrhsi 0 "No", add 
label define ocrhsi 1 "Yes, Hispanic serving", add 
label values ocrhsi ocrhsi
label define ocrmsi -1 "Enrollment data not reported" 
label define ocrmsi -2 "Not applicable, institution is not in-scope of MSI calculation", add 
label define ocrmsi 0 "No", add 
label define ocrmsi 1 "Yes, Minority serving", add 
label values ocrmsi ocrmsi
tab stabbr
tab fips
tab obereg
tab opeflag
...
summarize cotsfam
summarize fte
save working_data/dct_fa2000hd.dta, replace
